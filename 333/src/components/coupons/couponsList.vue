    ...
    <el-table
      ...
      <el-table-column fixed="right" label="操作" align="center" width="340">
        <template slot-scope="scope">
          <el-button type="warning"  @click="update(scope.$index,scope.row)">详情</el-button>
          <el-button type="warning"  @click="select(scope.$index,scope.row)">发布</el-button>
          <el-button type="warning"  @click="select(scope.$index,scope.row)">通过</el-button>
          <el-button type="warning"  @click="update(scope.$index,scope.row)">拒绝</el-button>
          <el-button type="warning"  @click="update(scope.$index,scope.row)">分配</el-button>
...
<script>
  ...
  export default {
    methods: {
      ...
      getList(){
        this.$http //列表加载
          .post(this.url + "adminInternal/selectItemsNoByNumber", {
            page:this.page,
