<template>
  <div>
    ...
    <div class="map-clock p-r">
      ...
      <div class="w-h-100 " v-if="viewBlock==3">
        <div class="middle_Box_one">
          <img src="../../assets/images/0190702152230.jpg" id="ceshiImg">
          <div class="p-r ds videoOne" v-for="item in 3">
            <div :class="item == 2?'check_false':'check_true'" v-for="item in 6"
                 @click="lookCheckMsg(item)"></div>
          </div>
        </div>
      </div>
    ...
    <div class="map-mini p-a">
      <!--地图-->
      <img class="w10" src="../../assets/images/map1.png" @click="chooseMap()" alt="">
      <!--全景-->
      <img class="w10" src="../../assets/images/map2.png" @click="ddMap()">
    </div>
    <!--    报警区域-->
    <div class="call" @click="callPhone" id="qq" v-if="viewBlock==2">
