...
<script>
  export default {
    ...
    methods: {
      //获取统计
      getState() {
        this._getData('/api/v1/data_statistics/yesterdayGoods', {id:3},
          data => {
            this.State = data;
          })
      },
      ...
      XQday() {
        this.Sselect(2);
        this._getData('/api/v1/data_statistics/old7Goods', {id:3},
          data => {
            this.State = data;
          })
      },
      XTday() {
        this.Sselect(3)
        this._getData('/api/v1/data_statistics/old30Goods', {id:3},
          data => {
            this.State = data;
          })
      },
