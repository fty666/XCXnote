<template>
  <div>
    <div class="head flex">
      <div class="font" style="width: 30%">会员统计</div>
      <div style="width: 60%">
        <div class="flex">
          <div class="head1 Mouse" style="margin-left: 15%" @click="exportFunc('memberTable','会员统计')">导出数据</div>
    ...
    <div style="border: 1px solid #ddd;height: 600px;">
      <div class="tables" id="memberTable">
        <el-table
          ref="multipleTable"
          :data="membeList"
          tooltip-effect="dark"
...
<script>
  export default {
    ...
    methods: {
      ...
      Xall() {
        this.Tselect(4);
        this._getData('/api/v1/alliance/allMember', {}, data => {
          this.membeList = data;
        })
      },
      Tselect(flag) {
