<template>
    ...
    <div class="flex whiteT" style="height: 120px">
      <div class="sequence" style="width: 70%;">
        ...
        <div class="input">
          <el-input v-model="input"  placeholder="请输入配货单号"></el-input>
        </div>
        ...
        <div class="font" style="margin-left: 60px">提交时间：</div>
        <div class="input" >
          <el-date-picker
            v-model="value1"
            style="width: 200px;"
        ...
        <div class="font" style="margin-left: 60px">至</div>
        <div class="input" >
          <el-date-picker
            v-model="value1"
            style="width: 200px;"
        ...
        <div class="font" style="margin-left: 60px">订单编号：</div>
        <div class="input">
          <el-input v-model="input"  placeholder="输入订单编号"></el-input>
        </div>
  
        <div class="font" style="margin-left: 60px">商品名称：</div>
        <div class="input">
          <el-input v-model="input"  placeholder="输入商品名称"></el-input>
        </div>
      </div>
        <!--按钮-->
        <div class="btn" style="margin-left: 88px;margin-top: 30px">
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <div class="flex">
              <div style="color: #0099ce;padding-left: 60px" @click="del(scope.row.id)">查看订单</div>
              <div style="color: #0099ce;padding-left: 20px" @click="del(scope.row.id)">删除订单</div>
            </div>
          </template>
        </el-table-column>
      </el-table>
